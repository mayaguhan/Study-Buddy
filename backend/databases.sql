...
START TRANSACTION;
USE `sb_homework`;
INSERT INTO `sb_homework`.`homework` (`homework_id`, `student_id`, `subject`, `meeting_type`, `title`, `description`, `price`, `image`, `deadline`, `created`, `status`) VALUES (1, 1, 'Math', 'Virtual', 'Help with Math Homework', 'How do I find these angles?', 5.00, 'https://i.imgur.com/mrImm4u.jpg', '2021-04-30 00:00:00', '2021-04-01 00:00:00', 'Unsolve');
INSERT INTO `sb_homework`.`homework` (`homework_id`, `student_id`, `subject`, `meeting_type`, `title`, `description`, `price`, `image`, `deadline`, `created`, `status`) VALUES (2, 2, 'English', 'Virtual', 'Fill in the word English Homework', 'Hello, I need help with this P5 English question, would be good if you can explain to me why those words are the answer', 5.00, 'https://i.imgur.com/VB9tG10.jpg', '2021-04-30 00:00:00', '2021-04-01 00:00:00', 'Unsolve');
...
INSERT INTO `sb_liaise`.`liaise` (`liaise_id`, `homework_id`, `tutor_id`, `offering`, `status`) VALUES (4, 1, 5, 6.20, 'Pending');
...
START TRANSACTION;
USE `sb_payment`;
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYRi5DZqxGmeqSxxgDRaS2T', 31, 1, 2, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYSCqDZqxGmeqSx0rdDcv6a', 32, 2, 1, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYSfYDZqxGmeqSxB8IwH2oA', 33, 3, 2, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYTJ1DZqxGmeqSx3mFdVb5N', 34, 1, 3, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYXImDZqxGmeqSxOYisxIpY', 35, 1, 2, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1Ibk2YDZqxGmeqSxB6OPesT4', 36, 2, 4, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYS4RDZqxGmejJe3BYtqSxd', 37, 2, 5, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYSeZDZqxGmeqS3VcxAgagp', 38, 3, 2, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IbjsKDZqxGmeqSx2ID1mbVJ', 39, 4, 1, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYS4RDZqxGmejJSxde3BYtq', 40, 5, 3, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1Ibk2YDZqxG4B6OPemeqSxsT', 41, 6, 2, '2021-04-01 00:00:00', "Complete");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYSeZDZqxG3VcxApmgageqS', 42, 7, 4, '2021-04-01 00:00:00', "Confirm");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYRi5DZqxGmeqDRaS2TSxxa', 43, 8, 1, '2021-04-01 00:00:00', "Confirm");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYSCqDZqx0rdDcv6aYtqSxd', 44, 9, 2, '2021-04-01 00:00:00', "Confirm");
INSERT INTO `sb_payment`.`payment` (`payment_id`, `liaise_id`, `sender_id`, `receiver_id`, `created`, `status`) VALUES ('pi_1IYSfYDZqxGm2oIweqSxHPes', 45, 10, 3, '2021-04-01 00:00:00', "Cancel");
COMMIT;